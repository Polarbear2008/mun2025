...
const EventUpdates = () => {
  ...
  return (
    <PageLayout>
      <Helmet>
        <title>Event Updates | FPSMUN</title>
        <meta name="description" content="Stay updated with the latest information about FPSMUN committees and schedule." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        >
          ...
          <p className="text-lg text-diplomatic-600 max-w-2xl mx-auto">
            Stay informed about the latest developments for FPSMUN Season 4, including committee information and event schedules.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-diplomatic-600 mb-6">
                Explore the various committees that will be part of FPSMUN Season 4, including topics, background guides, and committee structures.
              </p>
              <Link 
                to="/committees" 
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-diplomatic-600 mb-6">
                View the complete schedule for FPSMUN Season 4, including opening and closing ceremonies, committee sessions, and social events.
              </p>
              <Link 
                to="/schedule" 
                className="inline-flex items-center text-gold-500 font-medium hover:text-gold-600 transition-colors"
