...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Registration fees vary depending on whether you are registering as an individual delegate or as part of a delegation. Early bird rates and discounts for returning delegates are available. Please check the Registration page for current pricing details.'
  },
  {
