...
const timelineEvents = [
  ...
  },
  {
    ...
    description: 'Extended our reach to over 50 countries worldwide, establishing FPSMUN as a truly global conference.',
    milestones: [
      'Launched regional qualification events',
      'Established scholarship program for delegates from developing nations',
      'Published first edition of FPSMUN Journal of International Affairs'
    ]
  },
  {
    year: '2023',
